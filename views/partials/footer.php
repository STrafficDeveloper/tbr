    ...
    <div class="site-footer__inner">
        <div class="site-footer__brand">
            <div class="site-footer__lockup">
                <img src="<?= e(asset('img/logo-tbr.webp')) ?>" alt="The Bikers Ranger" width="120" height="61" loading="lazy">
                <span class="site-footer__x" aria-hidden="true">x</span>
                <img src="<?= e(asset('img/logo-raja-kapcai.webp')) ?>" alt="Raja Kapcai" width="60" height="61" loading="lazy">
            </div>
